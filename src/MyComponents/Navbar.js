...
const Navbar = () => {
  const handleGithub = () => {
    window.open('https://github.com/YuvBindal', '_blank');
  };
  const handleYoutube = () => {
    window.open('https://www.youtube.com/@yuvbindal1226', '_blank');
  };

  const handleDevpost = () => {
    window.open('https://devpost.com/yuv2bindal', '_blank');
  }
  const handleLinkedin = () => {
    window.open('https://www.linkedin.com/in/yuvbindal/', '_blank');
  }
  const handleInstagram = () => {
    window.open('https://www.instagram.com/yuvbindal/', '_blank');
  }
