  ...
  return (
    <div style = {home} className='home'>
        ...
        <div style = {aboutMe} className ='aboutMe'>
            <h1 style={strongHeading}>YUV BINDAL</h1>
            <hr></hr>
            <h2 style={secondHeading}>Founder of BlockState&copy;</h2>
            <p style={normalText}>Hey! I am Yuv, an aspiring technoprenuer. I am passionate about finding innovative solutions to global issues. I specialise in technologies such as Computer Vision, Blockchain, and Natural Language Processing.</p>
        </div>
